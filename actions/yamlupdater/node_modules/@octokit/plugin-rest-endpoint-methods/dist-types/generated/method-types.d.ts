...
export declare type RestEndpointMethods = {
    ...
    search: {
         ...
         *
         * When searching for code, you can get text match metadata for the file **content** and file **path** fields when you pass the `text-match` media type. For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
         ...
         *
         * When searching for commits, you can get text match metadata for the **message** field when you provide the `text-match` media type. For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
         ...
         *
         * When searching for issues, you can get text match metadata for the issue **title**, issue **body**, and issue **comment body** fields when you pass the `text-match` media type. For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
         ...
         *
         * When searching for labels, you can get text match metadata for the label **name** and **description** fields when you pass the `text-match` media type. For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
         ...
         *
         * When searching for repositories, you can get text match metadata for the **name** and **description** fields when you pass the `text-match` media type. For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
         ...
         *
         * When searching for users, you can get text match metadata for the issue **login**, **email**, and **name** fields when you pass the `text-match` media type. For more details about highlighting search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata). For more details about how to receive highlighted search results, see [TextComponent match metadata](https://developer.github.com/v3/search/#text-match-metadata).
         *
