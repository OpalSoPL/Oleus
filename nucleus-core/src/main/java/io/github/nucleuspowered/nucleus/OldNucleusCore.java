...
public class OldNucleusCore {
    ...
    @Inject
    public OldNucleusCore(
            final PluginContainer pluginContainer,
            @ConfigDir(sharedRoot = true) final Path configDir,
            final Logger logger,
            final Injector injector,
            final IModuleProvider moduleProvider) {
    ...
    public void onPreInit(final GamePreInitializationEvent preInitializationEvent) {
        ...
        game.getServiceManager().setProvider(this.pluginContainer, NucleusSafeLocationService.class, this.serviceCollection.teleportService());
